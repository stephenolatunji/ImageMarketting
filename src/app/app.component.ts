        ...
        if(task !== null) {
          ...
          task.forEach(task => {
            if(data.id == task.pocId) {
              ...
              else if(task.taskType == 'hero_pp'){
                data.hero_pp = task.action;
                data.hero_ppDate = task.date;
                data.hero_ppTime = task.time;
                (data.taskPercentage == undefined)? data.taskPercentage = 33.3 : (data.hero_ppAlready == undefined)? data.taskPercentage += 33.3 : null;
                data.hero_ppAlready = true;
              }
            }
          });
        }
