...
@Component({
  selector: 'app-trophy-lager',
  templateUrl: './trophy-lager.component.html',
  styleUrls: ['./trophy-lager.component.scss']
})
export class TrophyLagerComponent implements OnInit {
  ...
  getData(before, after, who) {
    this.loading = true;
    this.server.getTaskForAdminDashboard('chair', before, after).subscribe(data=>{
