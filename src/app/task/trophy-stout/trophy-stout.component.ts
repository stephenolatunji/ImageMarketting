...
@Component({
  selector: 'app-trophy-stout',
  templateUrl: './trophy-stout.component.html',
  styleUrls: ['./trophy-stout.component.scss']
})
export class TrophyStoutComponent implements OnInit {
  ...
  getData(before, after, who) {
    this.loading = true;
    this.server.getTaskForAdminDashboard('poster', before, after).subscribe(data=>{
